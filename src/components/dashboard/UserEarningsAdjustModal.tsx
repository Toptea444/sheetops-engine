  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center px-4">
      ...
      <AlertDialog open={aConfirming} onOpenChange={(o) => !o && setAConfirming(false)}>
        <AlertDialogContent className="border-red-300 dark:border-red-800 max-w-[92vw] sm:max-w-md">
          <AlertDialogHeader>
            <AlertDialogTitle className="flex items-center gap-2 text-red-700 dark:text-red-300">
              <AlertTriangle className="h-4 w-4 text-red-600 dark:text-red-400 shrink-0" />
              <span>Heads up — this is permanent</span>
            </AlertDialogTitle>
            <AlertDialogDescription className="space-y-3 pt-1">
              ...
              <span className="block rounded-md bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900 p-2.5 text-[12px] text-red-900 dark:text-red-200 leading-relaxed">
                ₦{aTotal.toLocaleString()} will be added to your earnings and removed from <strong>{fullSourceId}'s</strong> account. They will see an alert telling them you claimed this day.
                <br /><br />
