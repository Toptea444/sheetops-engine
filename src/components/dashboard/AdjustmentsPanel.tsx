      ...
      <CardContent className="pt-0">
        ...
        <div className="flex gap-2 mb-3 p-2.5 rounded-lg bg-muted/30 border border-border/50">
          ...
          <p className="text-[11px] text-muted-foreground leading-relaxed">
            Earnings adjustments are listed here. Some may be from admin changes, and some may be corrections submitted by you or another user. For ID swaps, your displayed totals combine the right earnings period for each ID.
          </p>
        </div>
